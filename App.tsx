...
import { Play, Instagram, Menu, X, Star, Mail, Disc, Film, Facebook, Youtube, ArrowRight, ShoppingBag, HardDrive } from 'lucide-react';

// --- Types & Constants ---
export type ServiceType = 'archive' | 'social' | null;

// --- Merged Component: MemorySlider ---
const MemorySlider: React.FC = () => {
  return (
    <div className="relative w-full max-w-4xl mx-auto py-12">
      {/* Tape Label Effect - Centered */}
      <div className="absolute -top-0 left-1/2 -translate-x-1/2 bg-tape/90 px-6 py-2 text-xs font-mono tracking-widest text-paper shadow-sm transform -rotate-1 z-20 border border-ink/10 select-none">
...
// --- Merged Component: CheckoutModal ---
...
const CheckoutModal: React.FC<CheckoutModalProps> = ({ isOpen, onClose, serviceType }) => {
